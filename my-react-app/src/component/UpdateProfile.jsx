...
import { profileChange,clearError } from '../Redux/Action/PofileAction'
...
function UpdateProfile() 
{
    ...
    const submitHandle = (e)=>
    {
        ...
        const formData = new FormData()
           ...
           dispatch(profileChange(formData))
        //    console.log(image)
                ...
                <div className=" bg-light p-30">
                    ...
                    <div className="control-group">
                        ...
                        <div className="control-group">
                            ...
                            <img src={user.image.url} width="50px" height="50px" className='m-3'/>
                            <p className="help-block text-danger"></p>
                        </div>
                        <div>
